...
class AICUP(ImageDataset):
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        # data_dir = osp.join(self.data_dir, 'AICUP-ReID_processed2')
        # data_dir = osp.join(self.data_dir, 'AICUP-ReID_CannyAfterEnhanced2')
        # data_dir = osp.join(self.data_dir, 'AICUP-ReID_day')
        # data_dir = osp.join(self.data_dir, 'AICUP-ReID_night')
        # data_dir = osp.join(self.data_dir, 'AICUP-ReID_processed_night_ALL_Vonly')
        data_dir = osp.join(self.data_dir, 'AICUP-ReID_example')
