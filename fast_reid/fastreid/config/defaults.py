...
# Pretrain model path
_C.MODEL.BACKBONE.PRETRAIN_PATH = r'D:\AICUP2024\SpringSeason\Cardetection\AICUP_Baseline_BoT-SORT-main\logs\AICUP_115\0507VIT(CannyAfterEnhancedV)150\model_0012.pth'
...
# Arcface Loss options
_C.MODEL.LOSSES.ARCFACE = CN()
_C.MODEL.LOSSES.ARCFACE.MARGIN = 0.5
_C.MODEL.LOSSES.ARCFACE.GAMMA = 0.1
_C.MODEL.LOSSES.ARCFACE.SCALE = 64
