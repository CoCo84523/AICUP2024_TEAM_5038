...
def arg_parse():
    ...
    parser.add_argument('--AICUP_dir',default=r'train', type=str, required=False, help='your AICUP dataset path')
    parser.add_argument('--MOT15_dir',default=r'Evaluation\train_MOT15', type=str, required=False, help='converted dataset directory')
