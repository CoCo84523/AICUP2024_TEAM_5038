...
def plot_one_box(x, img, score, color=None, label=None, line_thickness=3):
    ...
    if label:
        ...
        cv2.putText(img, label+"{:.2f}".format(score),(c1[0], c1[1] - 2), 0, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
