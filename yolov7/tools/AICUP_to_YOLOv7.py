...
def arg_parse():
    ...
    parser.add_argument('--AICUP_dir', type=str, default=r'train', help='your AICUP train dataset path')
    parser.add_argument('--YOLOv7_dir', type=str, default=r'AICUP-Yolov7', help='converted dataset directory')
    parser.add_argument('--train_ratio', type=float, default=0.84, help='The ratio of the train set when splitting the train set and the validation set')
